...
//    });
    ...
    $('.newEvent').click(function(e){
      ...
      var event = '<div class=\"fc-event\" style=\"background-color:'  + z + '">' + x + '<span class=\"evntDesc\">' + y +'</span></div>';
      $('.list').prepend(event);
    ...
    $('#calendar').fullCalendar({
      ...
      eventRender: function(event, element, id) {
        ...
        element.bind('contextmenu', function(e){
          ...
          console.log(element);
          element.parents('.fc-content').find('.fc-content:before').slideToggle();
        });
      },
      ...
      drop: function (start, end, allDay, delta, event) { //Save Data
        var title = $(this).text();
